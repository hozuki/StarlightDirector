    ...
    internal static class DirectorSettingsManager {
        ...
        public static void LoadSettings() {
            ...
            try {
                ...
                MessageBox.Show($"Failed to load director settings.{Environment.NewLine}{ex.Message}", ApplicationHelper.GetTitle(), MessageBoxButtons.OK, MessageBoxIcon.Warning);
                _editorSettings = new DirectorSettings();
            }
        }
        ...
        public static void SaveSettings() {
            ...
            try {
                ...
                MessageBox.Show($"Failed to save director settings.{Environment.NewLine}{ex.Message}", ApplicationHelper.GetTitle(), MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
