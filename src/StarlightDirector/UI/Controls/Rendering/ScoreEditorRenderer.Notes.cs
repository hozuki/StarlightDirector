...
namespace OpenCGSS.StarlightDirector.UI.Controls.Rendering {
    partial class ScoreEditorRenderer {
        ...
        private void DrawTapNote(Graphics context, Note note, float x, float y, float r) {
        ...
        private void DrawFlickNote(Graphics context, Note note, float x, float y, float r, NoteFlickType flickType) {
            DrawCommonNoteOutline(context, note, x, y, r);
        ...
        private void DrawHoldNote(Graphics context, Note note, float x, float y, float r) {
            DrawCommonNoteOutline(context, note, x, y, r);
        ...
        private void DrawSlideNote(Graphics context, Note note, float x, float y, float r, bool isMidway) {
            if (note.Basic.FlickType != NoteFlickType.None) {
