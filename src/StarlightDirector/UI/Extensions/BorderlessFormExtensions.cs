...
namespace OpenCGSS.StarlightDirector.UI.Extensions {
    public static class BorderlessFormExtensions {

        public static int DetermineNcRegion([NotNull] this Form form, Point mouseLocation, int horizontalMargin, int verticalMargin, int captionMargin) {
            var size = form.Size;
