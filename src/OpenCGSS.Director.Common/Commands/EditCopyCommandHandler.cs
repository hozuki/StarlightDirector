...
namespace OpenCGSS.Director.Common.Commands {
    [CommandHandler]
    public sealed class EditCopyCommandHandler : CommandHandlerBase<EditCopyCommandDefinition> {

        [ImportingConstructor]
        public EditCopyCommandHandler([NotNull] IShell shell) {
            _shell = shell;
        }
        ...
        public override void Update(Command command) {
            ...
            if (!(activeDocument is IBeatmapDocument extendedDocument)) {
                ...
                command.Enabled = extendedDocument.CanPerformCopy;
            }
        }
