...
namespace OpenCGSS.Director.Modules.SldProject.Models.Beatmap.Extensions {
    public static class ScoreExtensions {
        ...
        public static TimeSpan CalculateDuration([NotNull] this Score score) {
            ...
            var currentInterval = SldMathHelper.BpmToInterval(currentBpm);
                    ...
                    for (var i = 0; i < numGrids; ++i) {
                        if (bpmNoteIndex < bpmNotesInThisBar.Count) {
                            ...
                            if (i == bpmNote.Basic.IndexInGrid) {
                                ...
                                currentInterval = SldMathHelper.BpmToInterval(currentBpm);
        ...
        [NotNull]
        internal static IReadOnlyList<IReadOnlyList<TimeSpan>> UpdateNoteHitTimings([NotNull] this Score score) {
            var notes = score.GetAllNotes();
