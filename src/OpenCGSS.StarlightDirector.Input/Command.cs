...
namespace OpenCGSS.StarlightDirector.Input {
    public sealed class Command : DisposableBase, ICommand {
        ...
        internal void SubscribeControl([CanBeNull] Component control, bool setShortcut) {
            if (control == null) {
                return;
            }
        ...
        internal void UnsubscribeControl([CanBeNull] Component control) {
            if (control == null) {
                return;
            }
        ...
        private void OnQueryCanExecute([CanBeNull] object sender, [CanBeNull] QueryCanExecuteEventArgs e) {
            QueryCanExecute?.Invoke(sender, e);
        }

        private void OnQueryCanRevert([CanBeNull] object sender, [CanBeNull] QueryCanRevertEventArgs e) {
            QueryCanRevert?.Invoke(sender, e);
        }

        private void OnQueryRecordToHistory([CanBeNull] object sender, [CanBeNull] QueryRecordToHistoryEventArgs e) {
            QueryRecordToHistory?.Invoke(sender, e);
        }

        private void OnControlInteract([CanBeNull] object sender, [CanBeNull] EventArgs e) {
